...
Report bugs at https://github.com/AllenCellModeling/sarcomereannotation/issues.
...
SarcomereAnnotation could always use more documentation, whether as part of the
official SarcomereAnnotation docs, in docstrings, or even on the web in blog posts,
articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/AllenCellModeling/sarcomereannotation/issues.
...
Ready to contribute? Here's how to set up `sarcomereannotation` for local development.

1. Fork the `sarcomereannotation` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/sarcomereannotation.git
...
3. Install your local copy into a virtualenv (or anaconda environment). Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::
    ...
    $ mkvirtualenv sarcomereannotation
    $ cd sarcomereannotation/
...
3. The pull request should work for Python 3.6 and 3.7, and for PyPy. Check
   https://travis-ci.org/AllenCellModeling/sarcomereannotation/pull_requests
...
$ py.test tests.test_sarcomereannotation
