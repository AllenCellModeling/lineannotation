...
Report bugs at https://github.com/AllenCellModeling/lineannotation/issues.
...
The best way to send feedback is to file an issue at https://github.com/AllenCellModeling/lineannotation/issues.
...
Ready to contribute? Here's how to set up `lineannotation` for local development.

1. Fork the `lineannotation` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/lineannotation.git
...
3. The pull request should work for Python 3.6 and 3.7, and for PyPy. Check
   https://travis-ci.org/AllenCellModeling/lineannotation/pull_requests
